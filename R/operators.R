...
setMethod("acos", signature(x = "Rcpp_variable"), function (x) ACos(e1))
setMethod("asin", signature(x = "Rcpp_variable"), function (x) ASin(x))
setMethod("atan", signature(x = "Rcpp_variable"), function (x) ATan(x))
setMethod("cos", signature(x = "Rcpp_variable"), function (x)  Cos(x))
setMethod("cosh", signature(x = "Rcpp_variable"), function (x) Cosh(x))
setMethod("sin", signature(x = "Rcpp_variable"), function (x)  Sin(x))
setMethod("sinh", signature(x = "Rcpp_variable"), function (x) Sinh(x))
setMethod("tan", signature(x = "Rcpp_variable"), function (x)  Tan(x))
setMethod("tanh", signature(x = "Rcpp_variable"), function (x) Tanh(x))
setMethod("exp", signature(x = "Rcpp_variable"), function (x)  Exp(x))
# setMethod("ad_log", signature(e1 = "Rcpp_variable"), function (e1) adinr$log(e1))
setMethod("log10", signature(x = "Rcpp_variable"), function (x) Log10(x))
setMethod("sqrt", signature(x = "Rcpp_variable"), function (x)  Sqrt(x, 0.5))
setMethod("log", signature(x = "Rcpp_variable"), function (x, base=exp(1)){return(Log(x))})
