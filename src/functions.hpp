...
const variable operator+(const variable& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = left.info->value + right.info->value;
    variable::tape_g.stack.push_back(ret);
...
const variable operator+(const variable& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = left.info->value + right;
    variable::tape_g.stack.push_back(ret);
...
const variable operator+(const double& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = left + right.info->value;
    variable::tape_g.stack.push_back(ret);
...
const variable powvv(const variable& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = std::pow(left.info->value, right.info->value);
    variable::tape_g.stack.push_back(ret);
...
const variable powvd(const variable& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = std::pow(left.info->value, right);
    variable::tape_g.stack.push_back(ret);
...
const variable powdv(const double& left,
    ...
    variable dependent;
    ret->dependent = dependent.info;
    ret->dependent->value = std::pow(left, right.info->value);
    variable::tape_g.stack.push_back(ret);
